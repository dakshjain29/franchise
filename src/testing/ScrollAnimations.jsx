...
//   const getTransform = () => {
//     switch (direction) {
//       case 'up': return isVisible ? 'translateY(0)' : 'translateY(50px)';
//       case 'down': return isVisible ? 'translateY(0)' : 'translateY(-50px)';
//       case 'left': return isVisible ? 'translateX(0)' : 'translateX(50px)';
//       case 'right': return isVisible ? 'translateX(0)' : 'translateX(-50px)';
//       default: return isVisible ? 'translateY(0)' : 'translateY(50px)';
//     }
//   };
...
//             <div data-aos="fade-right" data-aos-delay="100" className="bg-white rounded-lg shadow-lg overflow-hidden">
...
//                   showcasing AOS's built-in directional animations.
//                 </p>
//               </div>
//             </div>

//             <div data-aos="fade-left" data-aos-delay="200" className="bg-white rounded-lg shadow-lg overflow-hidden">
...
//                   with a slight delay after the previous element.
//                 </p>
//               </div>
//             </div>
//           </div>
...
//       {/* Alternating Side Showcase Section (New) */}
...
//       {/* Chat-Style Message Section (New) */}
//       <section className="py-20 px-4 bg-gradient-to-r from-indigo-50 to-blue-50">
//         <div className="max-w-3xl mx-auto">
//           <h2 className="text-3xl md:text-4xl font-bold mb-16 text-center"
//               data-aos="fade-down">
//             Chat-Style Animations
//           </h2>
          
//           <div className="space-y-6">
//             {[
//               { sender: 'user', message: "Hey, have you seen those new alternating side animations?" },
//               { sender: 'bot', message: "Yes! They're great for creating visual rhythm and distinction between content types." },
//               { sender: 'user', message: "What's the best way to implement them?" },
//               { sender: 'bot', message: "Framer Motion makes it super easy. Just set different initial 'x' values based on the message type!" },
//               { sender: 'user', message: "Any performance concerns with all these animations?" },
//               { sender: 'bot', message: "Good question! Using 'whileInView' with 'viewport: {once: true}' helps optimize performance by only triggering animations once." }
//             ].map((item, index) => {
...
//               Choose the technique that works best for your needs and start creating engaging user experiences.
//             </p>
...
//               <p className="mb-4">Join our community to learn more about effective animations</p>
...
//             <p data-aos="fade-up">
//               Created with React, Framer Motion, and AOS
//             </p>
//             <p className="mt-4" data-aos="fade-up" data-aos-delay="100">
//               © {new Date().getFullYear()} Scroll Animations Demo
//             </p>
//           </div>
//         </div>
//       </footer>
